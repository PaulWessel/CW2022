...
gmt begin
	...
	gmt figure weighted_median_line_figs_2/widths_weighted_${chain}_${fw}_${median}m_${gaussian}g_${weights}w pdf,jpg
...
gmt begin
	gmt figure weighted_median_line_figs_2/filter_${chain}_median${median}_gaussian${gaussian}_weights${weights} jpg
...
gmt begin
	...
	gmt convert final_smooth_weighted_line/weighted_line_filtered_resampled_${chain}_${fw}.txt 1_sig.txt chain_std/weighted_width_R.txt chain_std/weighted_width_L.txt -A > weighted_median_line_and_width_${chain}.txt
